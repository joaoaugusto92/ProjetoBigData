		...
		<div className='flex-1 relative z-10 overflow-auto'>
			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
					...
					<StatCard name='Pedidos Pendente' icon={Clock} value={orderStats.pedidospendente} color='#F59E0B' />
					<StatCard
						...
						color='#10B981'
					/>
					<StatCard name='Pedidos Cancelados' icon={DollarSign} value={orderStats.pedidoscancelados} color='#EF4444' />
				</motion.div>
